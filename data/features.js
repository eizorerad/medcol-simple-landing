...
export const features4 = [
  {
    ...
    description:
      "Patients share their story in natural language—symptoms, timeline, meds, history, concerns, and goals.",
  },
  {
    icon: "unicon-model",
    title: "Clinician Intent Setting",
    description:
      "Clinicians set visit context, must-not-miss risks, or focus areas so summaries align with how the visit will run.",
  },
  {
    icon: "unicon-task-approved",
    title: "Clinician-Ready Summary",
    description:
      "Structured pre-visit summaries with key complaints, timeline, relevant history, and patient priorities.",
  },
  {
    icon: "unicon-touch-interaction",
    title: "Operational Readiness",
    description:
      "See who is prepared vs not prepared, send reminders, and reduce last-minute intake burden.",
  },
  {
    icon: "unicon-sub-volume",
    title: "Multilingual Support",
    description:
      "Web and mobile intake available in multiple languages to serve diverse patient populations.",
  },
  {
    icon: "unicon-currency",
    title: "Document Upload",
    description:
      "Patients can upload relevant documents, test results, and medical records before the visit.",
  },
];

export const featureItems = [
  {
    imageSrc: "/assets/images/template/previsit.png",
    altText: "Patient Pre-Visit Interview",
    title: "Patient Pre-Visit Interview",
    description:
      "Patients share their story in natural language, at their own pace—symptoms, timeline, meds, history, concerns, and goals. They can upload relevant documents via web or mobile.",
    linkText: "Learn more",
    icon: "unicon-cloud-download",
    reverseOrder: false,
  },
  {
    imageSrc: "/assets/images/template/previsit2.png",
    altText: "Clinician-Ready Summary",
    title: "Clinician-Ready Summary",
    description:
      "Medcol synthesizes intake into a structured view: key complaint + timeline, relevant history, meds, allergies, patient priorities and concerns, clarifying questions and follow-up items.",
...
export const features6 = [
  ...
  },
  {
    ...
    title: "Clinician Intent Setting",
    description:
      "Clinicians can set visit context such as the visit purpose, must-not-miss risks, or focus areas—so the summary is aligned with how the visit will run. Lightweight and optional.",
    link: null,
  },
  {
    id: 4,
