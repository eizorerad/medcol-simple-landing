...
export const tiers = [
  {
    ...
    features: [
      "Patient pre-visit interview",
      "Clinician-ready summaries",
      "300 requests per seat monthly",
      "Web & mobile intake links",
      "Email support",
    ],
  ...
  },
  {
    ...
    price: "$5,000",
    priceSuffix: "/ mo",
    description: "For clinics & health systems.",
    features: [
      "All <b>Clinician</b> features",
  ...
  },
  {
    ...
    price: "$1",
    priceSuffix: "/ unit",
    description: "For partners & platforms.",
    features: [
      "Per completed intake + summary",
      "Embed Medcol in your platform",
