...
export const metadata = {
  title:
    "Features || Medcol - AI-Powered Pre-Visit Preparation",
  description:
    "Explore Medcol's features: Patient pre-visit interview, clinician-ready summaries, clinician intent setting, and operational readiness dashboard.",
};
