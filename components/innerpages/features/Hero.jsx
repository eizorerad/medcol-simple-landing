          ...
          <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
            ...
            >
              ...
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                Medcol prepares both patients and clinicians before they meet—turning
                patient stories into clear, clinician-ready summaries that make every
                visit start with understanding.
              </p>
            </div>
