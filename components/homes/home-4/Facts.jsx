          ...
          <div className="section-inner panel">
            ...
            >
              <h2 className="h4 md:h3 m-0">
                Proven traction in a rapidly growing market
              </h2>
              <p className="fs-6 xl:fs-5 text-dark dark:text-white text-opacity-70">
                Medcol is positioned at the intersection of telemedicine, remote
                diagnostics, and AI-augmented clinical workflows.
              </p>
            </div>
            <div
